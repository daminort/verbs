...
export const selectMode = createSelector([location], location => {
...
export const selectDirection = createSelector([location], location => {
  const { pathname } = location;
...
export const selectIsNew = createSelector([location], location => {
  const { pathname } = location;
